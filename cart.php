...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
          ...
          </i> <span id="cart-item" class="badge badge-danger"></span></a>
        </li>
    </ul>
  </div>
</nav>
  ...
  <strong><?php if(isset($_SESSION['showAlert'])){
            echo $_SESSION['showAlert'];} else { echo 'none'; } unset($_SESSION['showAlert']);?>"
            </strong>
</div>
            <div class="table-responsive mt-2">
                <table class="table table-bordered table-stipend text-center">
                    <thead>
                    <tr>
                        <td colspan="7">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                )?"":"disabled"; ?>"><i class="fas fa-credit-card"></i>
                                &nbsp;&nbsp;Checkout</a>
                            </td>
                        </tr>
                    </tbody>
